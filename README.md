...
<br />
<div align="center">
  <a href="https://github.com/sgrazys/Trillo">
...
<br />
<br />
<a href="https://sgrazys.github.io/Trillo/">DEMO</a>
<!-- ·
...
-   A header section with a logo, a search bar, and a user navigation menu.
-   A sidebar navigation menu with options for hotel, flight, car rental, and tours.
-   A main content area displaying hotel details and information.
-   A gallery of hotel photos.
-   Overview details about the hotel, such as its name, star rating, location, and average rating.
-   A detailed description of the hotel, including its amenities and features.
-   User reviews with text, user images, and ratings.
-   A call-to-action section indicating the availability of free rooms and an option to book.

[![Trillo][product-screenshot]](https://sgrazys.github.io/Trillo/)
...
1. Clone the repo
    ```sh
    git clone https://github.com/sgrazys/Trillo.git
    ```
...
[product-screenshot]: ./img/trillo.png
